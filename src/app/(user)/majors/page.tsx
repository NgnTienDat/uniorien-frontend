    ...
    return (
        <Container>
            <div className="min-h-screen py-6">
                ...
                {/* Banner */}
                <div className="w-full h-40 sm:h-56 md:h-64 bg-white border rounded-xl flex items-center justify-center mb-6 shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-6 ">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border shadow-sm rounded-lg focus:ring-2 focus:ring-blue-400 outline-none bg-white"
                        />
                    </div>
                    <UOSelectBox />
                </div>
